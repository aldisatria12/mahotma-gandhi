...
//                        .padding(.top, -35)
                        ...
                        VStack {
                            ...
                            Text(vm.gameQuestion)
                                ...
                                .frame(width: 243 / 390 * UIScreen.main.bounds.width, height: 300 / 844 * UIScreen.main.bounds.height, alignment: .center)
                            Spacer()
                            Button(action: {
                                openCard.toggle()
                                ...
                                .frame(width: 200 / 390 * UIScreen.main.bounds.width, height: 40 / 844 * UIScreen.main.bounds.height, alignment: .center)
                            })
